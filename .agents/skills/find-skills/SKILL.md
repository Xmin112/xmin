...
description: >
  ...
  or wants to extend Codex's capabilities. Teaches Codex how to use `npx skills`
...
1. **Understand the need.** Identify the domain, the specific task, and whether
   ...
   handled well by Codex's built-in capabilities.
...
| Installed skill not appearing | Restart Codex (new conversation) |
